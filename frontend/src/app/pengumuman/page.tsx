            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <div className="mt-auto flex flex-wrap gap-4">
                  {item.fileUrl && (
                    <a href={`${process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_API_URL || "https://web-kecamatan-cigedug-backend-five.vercel.app"}${item.fileUrl}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary hover:text-primary-container font-semibold text-sm bg-primary/10 hover:bg-primary/20 px-4 py-2 rounded-full transition-colors">
