...
export const metadata: Metadata = {
  title: "Desa Sindangsari - Profil Desa",
  description: "Profil lengkap Desa Sindangsari, Kecamatan Cigedug, Kabupaten Garut.",
};


const potensiList = [
  { icon: "photo_camera", label: "Wisata Cadas Gantung (CG)", desc: "Destinasi wisata alam yang menawarkan pemandangan tebing eksotis." },
  { icon: "eco", label: "Sentra Kentang", desc: "Penghasil kentang berkualitas super yang menyuplai pasar di Jawa Barat." },
  { icon: "water_drop", label: "Sumber Air Pegunungan", desc: "Pemanfaatan potensi air bersih untuk kebutuhan warga melalui program SPAM." },
];

const programList = [
  "Pengembangan Wisata CG",
  "Program Air Bersih (SPAM)",
  "Peningkatan PADesa",
  "Optimalisasi Dana Desa",
];

const aparaturDesa = [
  { nama: "Jajang Asyidik (Dodoy)", jabatan: "Kepala Desa", icon: "person" },
...
export default function SindangsariPage() {
  const heroImage = getHeroImage("sindangsari", "/images/desa/sindangsari-hero.jpeg");
  return (
    <>
      {/* -- Hero ----------------------------------------------------------- */}
      <section className="relative w-full min-h-[480px] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 flex w-[200%] animate-slide-hero">
            ...
            <div className="w-1/2 h-full bg-cover bg-center" style={{ backgroundImage: `url('/images/desa/sindangsari-pelayanan.jpeg')` }} />
          </div>
        ...
        <div className="relative z-10 w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pb-16 pt-32">
          <nav className="flex items-center gap-2 text-white/60 text-label-md mb-6">
            ...
            <span className="material-symbols-outlined text-sm">chevron_right</span>
            <span className="text-white">Desa Sindangsari</span>
          </nav>
          ...
          <h1 className="text-display-lg text-white mb-3">Desa Sindangsari</h1>
          <p className="text-body-lg text-white/80 max-w-2xl leading-relaxed mb-6">
            Terkenal dengan wisata Cadas Gantung dan komoditas pertanian kentang unggulan.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
             <Link
               href={"/desa/segera-hadir?desa=Desa Sindangsari"}
          ...
          <div className="flex flex-wrap gap-4">
            {[
              { icon: "groups", val: "~5.800 Jiwa", label: "Penduduk" },
              { icon: "square_foot", val: "5,2 km²-", label: "Luas Wilayah" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-body-md text-on-surface-variant leading-relaxed">
                Nama Sindangsari bermakna 'Panyindangan nu Asri' atau tempat persinggahan yang nyaman. Cikal bakalnya bermula dari sebuah kawasan bernama 'Kubangan Cileuncang' yang kemudian berkembang menjadi Dusun Kubangsari di bawah kepemimpinan Buyut Jakerti. Wilayah ini akhirnya diresmikan menjadi Desa Sindangsari.
              </p>
            </div>
            ...
            <div>
              <div className="divide-y divide-outline-variant/40 rounded-2xl border border-outline-variant/40 overflow-hidden bg-white shadow-sm">
                {[
                  { label: "Kepala Desa", value: "Jajang Asyidik" },
                  { label: "Kode Pos", value: "44116" },
                  { label: "Luas Wilayah", value: "5,2 km²-" },
      ...
      <section className="py-section-gap bg-white border-y border-outline-variant/30">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="text-center mb-12">
            ...
            <h2 className="text-headline-lg text-on-surface mb-3">Aparatur Desa Sindangsari</h2>
      ...
      <section className="py-10 bg-surface border-t border-outline-variant/30">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex items-center justify-between">
          <Link href="/desa/cintanagara" className="flex items-center gap-2 text-label-md text-primary font-bold hover:underline"><span className="material-symbols-outlined text-base">arrow_back</span>Desa Cintanagara</Link>
          ...
          <Link href="/desa/sukahurip" className="flex items-center gap-2 text-label-md text-primary font-bold hover:underline">Desa Sukahurip<span className="material-symbols-outlined text-base">arrow_forward</span></Link>
        </div>
      </section>
    </>
  );
