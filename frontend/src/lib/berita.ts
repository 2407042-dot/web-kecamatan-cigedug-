  ...
  try {
    ...
    return data.map((b: any) => {
      ...
      return {
        ...
        snippet: snippetText,
        imageUrl: b.imageUrl ? (b.imageUrl.startsWith('http') ? b.imageUrl : `${process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_API_URL || "https://web-kecamatan-cigedug-backend-five.vercel.app"}${b.imageUrl}`) : null,
        content: b.content,
        folderName: ''
      };
    });
