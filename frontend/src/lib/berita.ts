  ...
  try {
    ...
    return data.map((b: any) => {
      ...
      return {
        ...
        snippet: snippetText,
        imageUrl: b.imageUrl ? (b.imageUrl.startsWith('http') ? b.imageUrl : `${process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_API_URL || "https://api-desa-cigedug.onrender.com"}${b.imageUrl}`) : null,
        content: b.content,
        folderName: ''
      };
    });
